 ...
 */
@Slf4j
@RestController("teacherScoreManagementController")
...
public class ScoreManagementController {
    ...
    public Result<List<CourseStudentTreeVO>> courseStudentTree(){
        ...
        return Result.success(scoreManagementService.courseStudentTree());
    }
     ...
     */
    @PostMapping("/add")
    public Result<String> addGrade(@RequestBody GradeAddDTO gradeAddDTO) {
        log.info("新增成绩, grade={}", gradeAddDTO);
        scoreManagementService.addGrade(gradeAddDTO);
